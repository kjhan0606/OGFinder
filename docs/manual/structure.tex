%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% DS9 Integrated Source Extractor Manual
% Style file (based on cuRAMSES-kjhan style)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\lstdefinestyle{tcl}{
    language=Tcl,
    morekeywords={proc,global,set,if,else,foreach,switch,catch,
    after,pack,grid,bind,ttk::frame,ttk::button,ttk::label,
    ttk::entry,ttk::separator,ttk::panedwindow,ttk::scrollbar,
    canvas,table,winfo,configure,update,idletasks,exec}
}

\lstdefinestyle{python}{
    language=Python,
    morekeywords={import,from,def,return,if,else,for,in,as,with,
    try,except,None,True,False,np,sep,fits,WCS}
}

\lstdefinestyle{bash}{
    language=bash,
    morekeywords={make,cd,cp,cat,zip,chmod,strip,ds9,ds9_sextract,pip,conda}
}
